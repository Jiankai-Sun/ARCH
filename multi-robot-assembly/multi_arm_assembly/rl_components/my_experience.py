...
class ExperienceBuffer:
    ...
    def __init__(self, env_info, algo_info, device, aux_tensor_dict=None):
        ...
        self.num_flow_features = algo_info['num_flow_features']
        ...
        self.flow_base_shape = (self.num_flow_features, )
    ...
    def _init_from_env_info(self, env_info):
        ...
        self.tensor_dict['flow_samples'] = self._create_tensor_from_space(gym.spaces.Box(low=0, high=1,shape=(self.flow_base_shape), dtype=np.float32), self.obs_base_shape)
