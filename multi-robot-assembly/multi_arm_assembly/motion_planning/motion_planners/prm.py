...
class DistancePRM(PRM):
    def __init__(self, distance_fn, extend_fn, collision_fn, samples=[], connect_distance=0.5):
        self.connect_distance = connect_distance
        super(self.__class__, self).__init__(distance_fn, extend_fn, collision_fn, samples=samples)
