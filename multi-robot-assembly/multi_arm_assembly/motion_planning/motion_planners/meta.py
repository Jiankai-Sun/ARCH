...
from multi_arm_assembly.motion_planning.motion_planners.lattice import (
    lattice,
)
from multi_arm_assembly.motion_planning.motion_planners.lazy_prm import (
    create_param_sequence,
    lazy_prm,
    lazy_prm_star,
)
from multi_arm_assembly.motion_planning.motion_planners.prm import prm
from multi_arm_assembly.motion_planning.motion_planners.rrt import rrt
from multi_arm_assembly.motion_planning.motion_planners.rrt_connect import (
    birrt,
    rrt_connect,
)
from multi_arm_assembly.motion_planning.motion_planners.rrt_star import (
    rrt_star,
)
from multi_arm_assembly.motion_planning.motion_planners.smoothing import (
    smooth_path,
)
...
def random_restarts(
    ...
    **kwargs,
    ...
    print(
        "Solutions ({}): {} | Time: {:.3f}".format(
            len(solutions),
            [(len(path), round(compute_path_cost(path, distance_fn), 3)) for path in solutions],
...
def solve(
    ...
    num_samples=100,
    smooth=None,
    smooth_time=INF,  # TODO: smooth_iterations
    weights=None,
    circular={},
    cost_fn=None,
    success_cost=INF,
    ...
    **kwargs,
    ...
    return smooth_path(
        path,
        extend_fn,
        collision_fn,  # sample_fn=sample_fn,
        distance_fn=distance_fn,
        cost_fn=cost_fn,
        max_iterations=smooth,
        max_time=remaining_time,
