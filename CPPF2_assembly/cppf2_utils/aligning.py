...
def estimateSimilarityTransform(source: np.array, target: np.array, verbose=False):
    ...
    SourceInliersHom, TargetInliersHom, BestInlierRatio, BestInlierIdx = getRANSACInliers(SourceHom, TargetHom, MaxIterations=nIter, PassThreshold=PassT, StopThreshold=StopT)
