...
class SingleRealsense(mp.Process):
    ...
    def start_recording(self, video_path: str, start_time: float=-1):
        assert self.enable_color or self.enable_depth
    ...
    def run(self):
        ...
        rs_config = rs.config()
        # print('---------------', w, h, fps, self.enable_color, self.enable_depth, self.enable_infrared)
        ...
        try:
            ...
            # print('self.serial_number: ', self.serial_number, rs_config) 
            # start pipeline
